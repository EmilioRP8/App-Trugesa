...
st.set_page_config(page_title="CALCULADORA DE COTIZACIONES", layout="centered")
...
if 'modo_servicio' not in st.session_state:
...
with st.sidebar:
    ...
    st.header("Selecciona el tipo de servicio")
    st.session_state['modo_servicio'] = st.selectbox(
        "Tipo de Servicio",
        ["Carga", "Pasaje", "Turismo", "Ejecutivo"]
    )
